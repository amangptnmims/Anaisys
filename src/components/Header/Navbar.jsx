...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* Desktop & Mobile Menu */}
      <nav className={`${isOpen ? 'block' : 'hidden'} md:block md:flex-1`}>
        <ul className={`${isOpen ? 'flex flex-col absolute top-16 left-0 right-0 bg-black p-4 space-y-4' : 'flex items-center space-x-4 md:space-x-10'} text-sm font-medium text-white md:ml-10 lg:ml-40`}>
          {/* Home Icon */}
          <li>
            <NavLink 
              to="/" 
